/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 63dbc1276defb9ddd0a19db62cc35610)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TG_BOT_TOKEN">> {}
}
